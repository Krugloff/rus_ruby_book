...
**Во второй версии Ruby** добавлена возможность откладывать итерирование элементов составного объекта (возможно бесконечного) до того момента как они потребуются.
