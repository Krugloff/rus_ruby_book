...
`\t` - перевод указателz курсора вправо, создавая отступ (табуляцию);
...
Полный синтакси регулярных выражений описывается в [приложении](appregexp).
...
С точки зрения синтаксиса, диапазоны - это два однотипых объекта, разделенные двумя или тремя точками. При использовании двух точек в диапазон включается конечная граница (`1..3` содержит числа 1, 2, 3), а при использовании трех - нет (`1...3` содержит числа 1 и 2).
