...
Это позволяет отмечать все используемые структуры без их действительного изменения (не устанавливая флаги), чтобы ядро могло грамотно распределять память между процессами.
