...
Используется для запрета использования потока в производных процессах.
...
Проверка закрыт ли поток для использования производными процессами.
...
Перебор строк (чтение выполняется с помощью `.readlines`). Во второй версии Ruby синоним lines признан устаревшим и возвращает массив всех строк.

`.bytes { |byte| } # -> self`  
Синонимы: `each_byte`

Перебор байтов. Во второй версии Ruby синоним bytes признан устаревшим и возвращает массив всех байт.

`.chars { |char| } # -> self`  
Синонимы: `each_char`

Перебор символов. Во второй версии Ruby синоним chars признан устаревшим и возвращает массив всех символов.

`.codepoints { |point| } # -> self`  
Синонимы: `each_codepoint`

Перебор кодовых позиций. Во второй версии Ruby синоним codepoints признан устаревшим и возвращает массив всех кодовых позиций.
