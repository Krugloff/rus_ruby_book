...
Составные типы данных могут содержать произвольный набор элементов (любых других типов данных). Составные типы позволяет группировать элементы и работать с полученной группой.
