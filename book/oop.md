...
Автор книги разделяет точку зрения, что в Ruby все аргументы передаются по ссылке. Это отражает суть происходящего, связанную с измением состояния, передаваемых аргументов, но хочется обратить внимание читателей, что передача аргументов методам, имеет свою специфику, связанную в основном с выражением присваивания и тонкостями терминологии в контексте языков высокого уровня.
~~~~~
