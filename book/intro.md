...
Программы выполняются с помощью компьютеров (вычисдительных машин) и представляют из себя описание последовательности действий, необходимых для получения какого-либо результата.
