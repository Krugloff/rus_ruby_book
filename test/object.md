...
`.module_exec( *arg = nil ) { |*arg| } # -> self [Module]`  
Синонимы: `class_exec`
...
`.instance_exec( *arg = nil ) { |*arg| } # -> self [Object]`
